...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BProcesa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mx/org/inegi/Imagenes/IProcesarArchivo.png"))); // NOI18N
        ...
        jButton1.setText("Conexion a h2 prueba");
...
if (dialogoArchivo.getFile() != null) { // Validar que se haya seleccionado un archivo
   ...
   new Thread(() -> {    
    ...
    try {
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(this, 
            "Favor de consultar al administrador: " + e.getMessage(), 
            "Error", 
            JOptionPane.ERROR_MESSAGE);
    } finally {
        try {
